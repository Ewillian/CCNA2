...
| ------------------ | --------------- | --------------- | --------------- | ---------------- | --------------- |
| `router1.lab3.tp4` | `10.3.100.1/30` | x               | x               | `10.3.100.11/30` | `10.33.10.254`  |
| `router2.lab3.tp4` | `10.3.100.2/30` | `10.3.100.4/30` | x               | x                | x               |
| `router3.lab3.tp4` | x               | `10.3.100.5/30` | `10.3.100.7/30` | x                | x               |
| `router4.lab3.tp4` | x               | x               | `10.3.100.8/30` | `10.3.100.10/30` | x               |
